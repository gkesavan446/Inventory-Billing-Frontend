              ...
              <div className="glass">
                <form className="form_container py-4" onSubmit={handleSubmit}>
                  <div className="title text-center m-4">
                    <h1 className="my-3 fw-bold" style={{ color: "#f2be13" }}>Register</h1>
                    <h5 style={{ color: "white" }}>Hello 🙋‍♂️, Welcome 😎 </h5>
                  </div>
                  <div className="m-2 col-8" style={{ color: "white" }}>
                  ...
                  <Button className="col-8 my-3 btn-warning" type="submit">
                    Register
                  </Button>
